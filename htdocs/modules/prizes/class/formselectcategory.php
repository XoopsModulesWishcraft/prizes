 ...
 * @subpackage form
 */
class PrizesFormSelectCategory extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function PrizesFormSelectCategory($caption, $name, $value = null, $size = 1, $multiple = false)
    {
		...
		foreach($categories as $category)
			$this->addOption($category->getVar('cid'), $category->getVar('title'));
