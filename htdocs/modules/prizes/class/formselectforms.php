 ...
 * @subpackage form
 */
class PrizesFormSelectForms extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function PrizesFormSelectForms($caption, $name, $value = null, $size = 1, $multiple = false)
    {
		...
		$formshandler =& xoops_getmodulehandler('forms', 'prizes');
		$forms = $formshandler->getObjects(NULL);
		foreach($forms as $form)
			$this->addOption($form->getVar('form_id'), $form->getVar('form_title'));
